...
ES_URL = 'http://localhost:9200/.alerts-security.alerts-mock/_doc/'

def generate_alert(i):
    now = datetime.now(timezone.utc)
    # Event happened between 1 and 48 hours ago
    event_time = now - timedelta(hours=random.randint(1, 48), minutes=random.randint(0, 59))
    # Alert generated 5 to 45 minutes after event (MTTD)
...
def main():
    print('Injecting mock alerts into Elasticsearch...')
    for i in range(100):
