    ...
    for _ in range(300):
        doc = {
            ...
            'destination': {
                ...
                'port': str(random.choice([80, 443, 53, 22, 3389])),
            ...
            'threat': {
                'intel': {'indicator': {'ip': '185.125.190.58', 'provider': 'Talos'}}
            }
        }
        if doc['network']['protocol'] == 'dns':
            ...
            doc['http'] = {
                ...
                'response': {'status_code': str(random.choice([200, 404, 500]))}
            }
...
if __name__ == '__main__':
    print('Injecting dynamic Network mock data...')
    inject_network()
    print('Done.')
